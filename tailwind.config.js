...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Adventure-themed primary colors
        primary: {
          50: '#fef3f2',
          100: '#fee5e2',
          200: '#fecfca',
      ...
      backgroundImage: {
        ...
        'adventure': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
      ...
      boxShadow: {
        'glow-sm': '0 0 10px rgba(245, 89, 70, 0.3)',
        'glow-md': '0 0 20px rgba(245, 89, 70, 0.4)',
        'glow-lg': '0 0 30px rgba(245, 89, 70, 0.5)',
